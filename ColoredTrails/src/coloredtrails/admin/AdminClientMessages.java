...
/**
 * Class documents all the JSON messages that the admin could send out
 *
...
public class AdminClientMessages {
    ...
    public static JsonObject getAddPlayerRequest(Integer gameId,
    ...
    public static JsonObject getRemovePlayerRequest(Integer gameId,
            List<String> playerIds) {
